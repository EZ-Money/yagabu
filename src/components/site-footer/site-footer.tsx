  ...
  render() {
    return (
      <div class="site-footer">
        ...
        <img id="logo" src="/assets/img/YagabuColoredLogo32x32.png" alt="Stencil Logo"></img>

        <a href="https://github.com/ionic-team/stencil">
          Yagabu - Copyright 2018
        </a>
  ...
  render() {
    return (
      <div class="site-footer">
       ...
       <div class="footer-info-left">© 2018 — Yagabu Golf Corporation</div>
